...
class _MovieDetailsState extends State<MovieDetails> {
  ...
  {
    var provider = Provider.of<MovieModel>(context, listen:false);
    var movie = provider.get(widget.id);
                        ...
                        children: <Widget>[
                          ...
                          ElevatedButton.icon(onPressed: () async {//this function is asynchronous now
                            if (_formKey.currentState?.validate() ?? false)
                            {
                              ...
                              //update the model
                              if (adding) {
                                await provider.add(movie!);
                              } else {
                                await provider.updateItem(widget.id!, movie!);
                              }
